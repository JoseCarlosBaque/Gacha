...
public class Tienda2 extends javax.swing.JFrame {
    ...
    public Tienda2() {
        ...
        jLabel3.setText("Tienes: " + user.getItems().get(1).getCantidad() + user.getItems().get(1).getNombre());
    }
    ...
    private void jComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComprarActionPerformed
        ...
        if (user.getItems().get(1).getCantidad() > 1 && (precio <= user.getItems().get(1).getCantidad())) {
            user.getItems().get(1).setCantidad(user.getItems().get(1).getCantidad() - precio);
            ...
            JOptionPane.showMessageDialog(null, "No tienes suficientes " + user.getItems().get(1).getNombre());
        }
